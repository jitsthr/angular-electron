...
var AppComponent = /** @class */ (function () {
    function AppComponent(_router, _electronService, _ngZone) {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._electronService.ipcRenderer.on('navigateTo', function (event, arg) {
            _this._ngZone.run(function () {
                _this.navigateTo(event, arg);
            });
        });
    };
    AppComponent.prototype.navigateTo = function (event, arg) {
        console.log(arg);
...
/* harmony import */ var _hero_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./hero.service */ "./src/app/hero.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                _hero_service__WEBPACK_IMPORTED_MODULE_13__["HeroService"],
...
var HeroService = /** @class */ (function () {
    ...
    HeroService.prototype.getHero = function (id) {
        ...
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (_) { return _this.log("fetched hero id=" + id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError("getHero id=" + id)));
    };
...
var HeroesComponent = /** @class */ (function () {
    ...
    HeroesComponent.prototype.add = function (heroName) {
        ...
        this.heroService.addHero({ name: heroName }).subscribe(function (hero) { _this.heroes.push(hero); });
    };
...
module.exports = __webpack_require__(/*! E:\Jitendra\AngularProject\angular-tour-of-heroes\src\main.ts */"./src/main.ts");
